...
export default function DeltaChart({ data }) {
  ...
  return (
    <div className="rc-card rc-accent-rail rounded-xl p-4" style={{ '--accent-color': 'var(--rc-purple)' }}>
      <div className="mb-3 text-xs uppercase tracking-widest text-[var(--rc-text-secondary)]">Speed Delta (D1 - D2)</div>
      <svg viewBox={`0 0 ${width} ${height}`} className="h-[300px] w-full">
        ...
        <line x1={pad.l} y1={baselineY} x2={width - pad.r} y2={baselineY} stroke="#64748B" strokeDasharray="4 4" strokeWidth="1" />
        <path d={path} stroke="#22D3EE" strokeWidth="2.2" fill="none" />
